...
contract Peak is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 11000 ether;
    // Initial distribution for the day 2-5 PEAK-WFTM LP -> PEAK pool
    uint256 public constant INITIAL_PEAK_POOL_DISTRIBUTION = 140000 ether;
    ...
    /**
     * @notice Constructs the PEAK ERC-20 contract.
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("PEAK", "PEAK") {
